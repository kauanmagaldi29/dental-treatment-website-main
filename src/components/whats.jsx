...
const Whats = () => {
    return (
        <div className="fixed bottom-4 right-4 z-50">
            <a
                href="https://wa.me/554988773414?text=Vim%20do%20site%2C%20preciso%20fazer%20um%20procedimento"
                target="_blank"
                rel="noopener noreferrer"
                className="whatsapp-button bg-green-500 p-3 rounded-full shadow-lg hover:bg-green-600 transition"
            >
                <svg
                ...
                >
                    <path
                        d="M256.064,0h-0.128l0,0C114.784,0,0,114.816,0,256c0,56,18.048,107.904,48.736,150.048l-31.904,95.104l98.4-31.456C155.712,496.512,204,512,256.064,512C397.216,512,512,397.152,512,256S397.216,0,256.064,0z"
                        fill="#4CAF50"
                    />
                    <path
